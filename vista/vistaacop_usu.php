...
function datos(){
  var respuesta = confirm("¿Deseas actualizar tus datos personales?");
    ...
    <div class="sales-boxes">
        ...
        <div class="top-sales box">
          <div class="title">ACTUALIZACION DATOS</div>
            ...
            <input type="submit" name="actualizar2" class="actualizar" value="Actulizar" onclick="return datos()">
             ...
             ?>
              ...
              foreach($datos as $f){
                ...
                <form>
                   ...
                   <label>Fecha Nacimiento: <?php echo $f[7]; ?></label>
                </form>
              <?php
